...
(function (global) {
  ...
  function DxfRenderer(canvas) {
    ...
    this._panning = false;
    this.snap = { on: false, modes: { endpoint: true, nearest: true, center: true, mid: false, perp: false, intersect: false } };
  ...
  DxfRenderer.prototype._drawText = function (ctx, e, s, SX, SY) {
    ...
    if (typeof ShxText !== 'undefined') {
      ...
      st = ShxText.resolveStyle(pk, bk);
    }
    if (st && st.ok && !e._forceSys) { this._drawTextShx(ctx, e, s, SX, SY, st); return; }
  ...
  DxfRenderer.prototype._drawTextSys = function (ctx, e, s, SX, SY) {
    ...
    ctx.font = Math.max(3, h) + 'px ' + family;
  ...
  DxfRenderer.prototype._drawTextShx = function (ctx, e, s, SX, SY, st) {
    ...
    ctx.save();
    ctx.strokeStyle = this.colorOf(e);
    ctx.lineWidth = 1;
